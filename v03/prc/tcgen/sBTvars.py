...
sbtProdDirTcdiag='%s/products-%s/tcdiag'%(sbtRoot,versionDev)
sbtProdDirTcgen='%s/products-%s/tcgen'%(sbtRoot,versionDev)
sbtProdDirWxmap2='%s/products-%s/wxmap2'%(sbtRoot,versionDev)
